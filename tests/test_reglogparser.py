    ...
    def test_expand_ops(self):
        test_df = pd.DataFrame(
            [
                ...
                {"reg": 7, "val": 1, "diff": 32, "op": SET_OP, "description": 0},
                {"reg": FRAME_REG, "val": 0, "diff": 19000, "description": 0},
                {"reg": 7, "val": 2, "diff": 32, "op": FLIP_OP, "description": 0},
                {"reg": FRAME_REG, "val": 0, "diff": 19000, "description": 0},
                {"reg": FRAME_REG, "val": 0, "diff": 19000, "description": 0},
                {"reg": FRAME_REG, "val": 0, "diff": 19000, "description": 0},
                {"reg": 7, "val": 0, "diff": 32, "op": FLIP_OP, "description": 0},
            ],
            dtype=MODEL_PDTYPE,
        )
        ...
        test_df = pd.DataFrame(
            [
                ...
                {"reg": FRAME_REG, "val": 0, "diff": 19000, "description": 0},
                {"reg": 7, "val": 2, "diff": 32, "op": FLIP_OP, "description": 0},
                {"reg": DELAY_REG, "val": 3, "diff": 19000, "description": 0},
                {"reg": 7, "val": 0, "diff": 32, "op": FLIP_OP, "description": 0},
            ],
            dtype=MODEL_PDTYPE,
        )
        ...
        test_df = pd.DataFrame(
            [
                ...
                {"reg": 7, "val": 1, "diff": 32, "op": SET_OP, "description": 0},
                {"reg": FRAME_REG, "val": 0, "diff": 19000, "description": 0},
                {"reg": DELAY_REG, "val": 2, "diff": 19000, "description": 0},
                {"reg": 7, "val": 2, "diff": 32, "op": SET_OP, "description": 0},
                {"reg": 9, "val": 2, "diff": 32, "op": SET_OP, "description": 0},
            ],
            dtype=MODEL_PDTYPE,
        )
        expand_df = pd.DataFrame(
