...
./build.sh
CARGS="--no-require-pq --layers 4 --heads 4 --kv-heads 4 --embed 256 --batch-size 128 --seq-len ${SLEN} --tkvocab ${TKVOCAB} --df-map-csv /scratch/preframr/df-map.csv --no-max-autotune"
