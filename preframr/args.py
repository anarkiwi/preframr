...
def add_args(parser):
    ...
    parser.add_argument("--prompt-seq-len", type=int, default=4096)
    ...
    parser.add_argument("--shuffle", type=float, default=0.02)
    parser.add_argument("--augment-rotate", action=BooleanOptionalAction, default=True)
    parser.add_argument("--norm-order", type=int, default=1)
